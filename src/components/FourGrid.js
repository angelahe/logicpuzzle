...
const FourGrid = ({ gridnum, squares, toggleSquare }) => (
  <div className="four-grid">
    ...
    <div className = "board-row">
      <Square key = {0} squarestate = {squares[4]} 
        onClick={() => toggleSquare(gridnum, 4)} 
      />
      <Square key = {1} squarestate = {squares[5]} 
        onClick={() => toggleSquare(gridnum, 5)} 
      />
      <Square key = {2} squarestate = {squares[6]} 
        onClick={() => toggleSquare(gridnum, 6)} 
      />
      <Square key = {3} squarestate = {squares[7]} 
        onClick={() => toggleSquare(gridnum, 7)} 
      />
    </div>
    <div className = "board-row">
      <Square key = {0} squarestate = {squares[8]} 
        onClick={() => toggleSquare(gridnum, 8)} 
      />
      <Square key = {1} squarestate = {squares[9]} 
        onClick={() => toggleSquare(gridnum, 9)} 
      />
      <Square key = {2} squarestate = {squares[10]} 
        onClick={() => toggleSquare(gridnum, 10)} 
      />
      <Square key = {3} squarestate = {squares[11]} 
        onClick={() => toggleSquare(gridnum, 11)} 
      />
    </div>
    <div className = "board-row">
      <Square key = {0} squarestate = {squares[12]} 
        onClick={() => toggleSquare(gridnum, 12)} 
      />
      <Square key = {1} squarestate = {squares[13]} 
        onClick={() => toggleSquare(gridnum, 13)} 
      />
      <Square key = {2} squarestate = {squares[14]} 
        onClick={() => toggleSquare(gridnum, 14)} 
      />
      <Square key = {3} squarestate = {squares[15]} 
